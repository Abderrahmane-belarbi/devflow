...
export default function NoResult({title, description, link, linkTitle}: Props){
  return <div className="my-10 flex w-full flex-col items-center justify-center">
    <Image
    ...
    <Link href={link}>
      ...
      hover:bg-primary-100 dark:bg-primary-500 dark:text-light-900">{linkTitle}</Button>
    </Link>
  </div>
}